            ...
            <div className="flex items-center justify-center my-10">
                <div className="flex flex-col items-center justify-center gap-8">
                    <div className="space-y-2 flex flex-col items-center justify-center">
                        ...
                        <p className="text-muted-foreground text-center w-[70%]">Weather you are just trying out our service or need more we&apos;ve got you covered</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="shadow-lg h-full bg-white rounded-md">
                            <div className="p-8">
                                <h2 className="font-semibold text-lg text-center">Free</h2>
                                <p className="text-muted-foreground text-sm text-center">For small side projects</p>
                                <h2 className="font-bold text-4xl text-center mt-3">$0</h2>
                                <p className="text-muted-foreground text-center text-sm">Per month</p>
                            </div>
                        ...
                        <div className="shadow-lg h-full bg-white border border-primary rounded-md relative">
                            <Badge className="absolute top-[-15px] right-[32%]">Upgrade Now</Badge>
                            <div className="p-8">
                                <h2 className="font-semibold text-lg text-center">Free</h2>
                                <p className="text-muted-foreground text-sm text-center">For small side projects</p>
